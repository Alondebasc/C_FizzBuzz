...
router.post('/products',authenticator,createAuthorizer('manager'), async (req, res, next) => {
  try {
...
router.put('/products/:id',authenticator,createAuthorizer('manager'), async (req, res, next) => {
  try {
    const id = Number.parseInt(req.params.id)
    const name = req.body.name
    const price = roundPrice(req.body.price)
...
router.patch('/products/:id',authenticator,createAuthorizer('manager'), async (req, res, next) => {
  try {
    const id = Number.parseInt(req.params.id)
    const name = req.body.name
    const price = roundPrice(req.body.price)
...
router.delete('/products/:id',authenticator,createAuthorizer('manager'), async (req, res, next) => {
  try {
    const id = Number.parseInt(req.params.id)
