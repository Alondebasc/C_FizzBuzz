...
<template>
  <main>
    ...
    <div v-else-if="product && !productIsDeleted" class="content">
      ...
      <button @click="editProduct" class="edit" v-if="authenticationService.user.value && authenticationService.user.value.role === 'manager' && !productIsDeleted.value"><EditIcon /></button>
